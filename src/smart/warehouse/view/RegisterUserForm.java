...
public class RegisterUserForm extends javax.swing.JFrame {
    ...
    public RegisterUserForm() {
        initComponents();
        lblUserId.setText(userBO.getNextId());
    }
    ...
    private void btnAddUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddUserActionPerformed
        ...
        try{
            if(userBO.addUser(new UserDTO(lblUserId.getText(),
                    txtUserName.getText(),
                    txtUserAddress.getText(),
                    txtUSerNic.getText(),
                    txtUserTelNumber.getText(),
                    txtUserEmail.getText(),
                    null)
                   
            )){
                JOptionPane.showMessageDialog(this,"User Adedd!");
