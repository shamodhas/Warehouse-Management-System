...
public class CloseStorageForm extends javax.swing.JFrame {
    ...
    public CloseStorageForm() {
        ...
        for(String warehouseId: storageBO.getAllReturnedWarehouseID()){
            cmbWarehouseCode.addItem(warehouseId);
        }
    }
    ...
    private void initComponents() {
        ...
        cmbWarehouseCode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cmbWarehouseCodeActionPerformed(evt);
            }
        });
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(lblUserID, javax.swing.GroupLayout.PREFERRED_SIZE, 303, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(lblUserID, javax.swing.GroupLayout.PREFERRED_SIZE, 47, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnTerminateStorageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTerminateStorageActionPerformed
        if(storageBO.deleteStorage(warehouseDTO)){
            JOptionPane.showMessageDialog(this, "Storage Was Deleted!");
            CloseStorageForm closeStorageForm=new CloseStorageForm();
            closeStorageForm.setVisible(true);
            this.dispose();
        }else{
            JOptionPane.showMessageDialog(this, "Storage Was Not Deleted!");
        }
    ...
    private void cmbWarehouseCodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbWarehouseCodeActionPerformed
        if(cmbWarehouseCode.getSelectedItem()==null)return;
        try{
            warehouseDTO=storageBO.searchWarehouse((String) cmbWarehouseCode.getSelectedItem());
            lblUserID.setText(warehouseDTO.getUserId());
            lblDescription.setText(warehouseDTO.getDescription());
            lblReseiveDate.setText(warehouseDTO.getReseiveDate().toString());
            lblWidth.setText(String.valueOf(warehouseDTO.getWidth()));
            lblLength.setText(String.valueOf(warehouseDTO.getLength()));
            
        }catch(NotFoundException e){
            JOptionPane.showMessageDialog(this, e);
        }
    }//GEN-LAST:event_cmbWarehouseCodeActionPerformed
